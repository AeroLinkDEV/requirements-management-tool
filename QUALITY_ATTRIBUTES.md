...
The product should begin as a modular system with clear domain boundaries and controlled migrations. Technical architecture will be chosen later; this document does not mandate a language, framework, database, or deployment packaging.
