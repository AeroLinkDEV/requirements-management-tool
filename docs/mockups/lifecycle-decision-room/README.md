...
![Release Readiness](01-release-readiness.png)
...
![Change Impact Review](02-change-impact-review.png)

The selected SRCR is presented as a read-only impact story connecting affected requirements, verification, evidence, revision redlines, and the exact work needed to close gaps.

## 3. Release Evidence and Decision

![Release Evidence and Decision](03-release-evidence-decision.png)
...
- Requirement introductions, modifications, and retirements remain in change request workflows.
