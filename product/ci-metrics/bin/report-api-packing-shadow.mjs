...
console.log(`[ci-metrics] API packing shadow: ${report.discovery.testCount} tests across ${report.discovery.classCount} classes; evidence=${report.evidence.structurallyCompatible ? 'structurally-compatible-offline-claims' : 'fallback'}; authenticity=${report.evidence.authenticity}; adoptionEligible=false; noSpeedupClaim=true`)
