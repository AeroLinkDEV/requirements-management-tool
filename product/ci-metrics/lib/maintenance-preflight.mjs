...
export const MAINTENANCE_KERNEL_PATHS = [
  ...
  'product/ci-metrics/lib/maintenance-evidence-reader.mjs',
  'product/ci-metrics/lib/maintenance-candidate.mjs',
  'product/ci-metrics/bin/detect-maintenance-candidate.mjs',
