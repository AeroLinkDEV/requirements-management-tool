...
Generated by `product/test-contracts/tools/generate-host-classification.mjs`, derived from the intent
inventory and current source rather than hand-maintained:

| Classification | Classes | Tests | Share |
|---|---:|---:|---:|
| reusable-host | 62 | 344 | 77.8% |
