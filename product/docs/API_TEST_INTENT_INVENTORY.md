...
**736 test methods, 820 known invocations, 118 classes.** This source-exact forecast supports planning only;
...
**706 methods / 776 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 438 | 490 | 97 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 776 cases (2.1%)**,
