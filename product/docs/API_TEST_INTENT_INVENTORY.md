...
**774 test methods, 858 known invocations, 121 classes.** This source-exact forecast supports planning only;
...
**744 methods / 814 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 473 | 525 | 100 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 814 cases (2.0%)**,
