...
**696 test methods, 772 known invocations, 113 classes.** This source-exact forecast supports planning only;
...
**669 methods / 736 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 419 | 471 | 94 | API (must stay hosted) |
| EF translation / relational constraints | 149 | 160 | 55 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 78 | 82 | 45 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 736 cases (2.2%)**,
