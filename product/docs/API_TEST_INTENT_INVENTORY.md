...
**656 test methods, 722 known invocations, 110 classes.** This source-exact forecast supports planning only;
...
**630 methods / 687 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 400 | 442 | 91 | API (must stay hosted) |
| EF translation / relational constraints | 141 | 152 | 53 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 65 | 69 | 41 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 687 cases (2.3%)**,
