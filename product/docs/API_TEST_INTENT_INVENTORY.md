...
**930 test methods, 1046 known invocations, 147 classes.** This source-exact forecast supports planning only;
...
**882 methods / 976 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 576 | 650 | 114 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 976 cases (1.8%)**,
