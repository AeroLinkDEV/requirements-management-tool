...
**718 test methods, 801 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**689 methods / 758 cases have direct host evidence**,
...
The known hosted candidate share is **16 of 758 cases (2.1%)**,
