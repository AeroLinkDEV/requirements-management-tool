...
**908 test methods, 1019 known invocations, 144 classes.** This source-exact forecast supports planning only;
...
**860 methods / 949 cases have direct host evidence**,
...
The known hosted candidate share is **18 of 949 cases (1.9%)**,
