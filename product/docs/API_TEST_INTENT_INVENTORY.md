...
**875 test methods, 972 known invocations, 131 classes.** This source-exact forecast supports planning only;
...
**834 methods / 917 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 549 | 614 | 105 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 917 cases (1.7%)**,
