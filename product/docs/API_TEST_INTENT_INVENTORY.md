...
**985 test methods, 1125 known invocations, 155 classes.** This source-exact forecast supports planning only;
...
**936 methods / 1054 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 610 | 696 | 122 | API (must stay hosted) |
| EF translation / relational constraints | 184 | 198 | 67 | Infrastructure (needs a database, not a host) |
...
The known hosted candidate share is **18 of 1054 cases (1.7%)**,
