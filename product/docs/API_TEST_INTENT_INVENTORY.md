...
**999 test methods, 1144 known invocations, 158 classes.** This source-exact forecast supports planning only;
...
**944 methods / 1067 cases have direct host evidence**,
...
The known hosted candidate share is **19 of 1067 cases (1.8%)**,
