...
**873 test methods, 970 known invocations, 131 classes.** This source-exact forecast supports planning only;
...
**832 methods / 915 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 547 | 612 | 105 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 915 cases (1.7%)**,
