...
**909 test methods, 1020 known invocations, 144 classes.** This source-exact forecast supports planning only;
...
**861 methods / 950 cases have direct host evidence**,
...
The known hosted candidate share is **18 of 950 cases (1.9%)**,
