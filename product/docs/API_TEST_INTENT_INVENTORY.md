...
**686 test methods, 754 known invocations, 112 classes.** This source-exact forecast supports planning only;
...
**659 methods / 718 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 412 | 456 | 93 | API (must stay hosted) |
| EF translation / relational constraints | 146 | 157 | 54 | Infrastructure (needs a database, not a host) |
...
The known hosted candidate share is **16 of 718 cases (2.2%)**,
