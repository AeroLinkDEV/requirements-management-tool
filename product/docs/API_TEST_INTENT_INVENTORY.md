...
**706 test methods, 787 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**677 methods / 744 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 423 | 475 | 95 | API (must stay hosted) |
| EF translation / relational constraints | 149 | 160 | 55 | Infrastructure (needs a database, not a host) |
...
The known hosted candidate share is **16 of 744 cases (2.2%)**,
