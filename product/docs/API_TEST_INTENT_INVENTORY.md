...
**858 test methods, 955 known invocations, 127 classes.** This source-exact forecast supports planning only;
...
**820 methods / 903 cases have direct host evidence**,
...
The known hosted candidate share is **16 of 903 cases (1.8%)**,
