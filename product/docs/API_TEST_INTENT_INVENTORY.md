...
**722 test methods, 805 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**693 methods / 762 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 430 | 484 | 95 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 762 cases (2.1%)**,
