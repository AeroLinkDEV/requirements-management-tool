...
**817 test methods, 906 known invocations, 122 classes.** This source-exact forecast supports planning only;
...
**787 methods / 862 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 514 | 571 | 101 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 862 cases (1.9%)**,
