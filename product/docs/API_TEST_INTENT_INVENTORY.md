...
**976 test methods, 1111 known invocations, 154 classes.** This source-exact forecast supports planning only;
...
**927 methods / 1040 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 604 | 690 | 121 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 1040 cases (1.7%)**,
