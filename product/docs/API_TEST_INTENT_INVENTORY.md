...
**656 test methods, 714 known invocations, 111 classes.** This source-exact forecast supports planning only;
...
**636 methods / 685 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 404 | 438 | 93 | API (must stay hosted) |
| EF translation / relational constraints | 139 | 150 | 53 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 67 | 71 | 43 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 685 cases (2.3%)**,
