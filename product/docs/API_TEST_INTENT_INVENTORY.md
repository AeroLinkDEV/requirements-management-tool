...
**1002 test methods, 1147 known invocations, 159 classes.** This source-exact forecast supports planning only;
...
**947 methods / 1070 cases have direct host evidence**,
...
| Authentication / authorization wiring | 117 | 135 | 68 | API (must stay hosted) |
...
The known hosted candidate share is **19 of 1070 cases (1.8%)**,
