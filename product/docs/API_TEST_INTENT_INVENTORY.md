...
**676 test methods, 744 known invocations, 110 classes.** This source-exact forecast supports planning only;
...
**649 methods / 708 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 407 | 451 | 91 | API (must stay hosted) |
| EF translation / relational constraints | 145 | 156 | 53 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 74 | 78 | 43 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 708 cases (2.3%)**,
