...
**972 test methods, 1103 known invocations, 153 classes.** This source-exact forecast supports planning only;
...
**923 methods / 1032 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 600 | 682 | 120 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 1032 cases (1.7%)**,
