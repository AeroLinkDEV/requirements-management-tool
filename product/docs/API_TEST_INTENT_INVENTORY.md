...
**913 test methods, 1024 known invocations, 146 classes.** This source-exact forecast supports planning only;
...
**865 methods / 954 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 568 | 637 | 112 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 954 cases (1.9%)**,
