...
**780 test methods, 864 known invocations, 121 classes.** This source-exact forecast supports planning only;
...
**750 methods / 820 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 478 | 530 | 100 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 820 cases (2.0%)**,
