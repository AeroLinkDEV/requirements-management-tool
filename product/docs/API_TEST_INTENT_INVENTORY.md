...
**897 test methods, 1005 known invocations, 139 classes.** This source-exact forecast supports planning only;
...
**850 methods / 936 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 560 | 628 | 109 | API (must stay hosted) |
...
| In-process logic with no HTTP and no client | 40 | 40 | 16 | Domain or Infrastructure (migration candidate) |
...
The machine-readable artifact records **17 explicitly hosted candidate methods / 17 cases** and **7 unknown candidate methods / 15 cases**.
The known hosted candidate share is **17 of 936 cases (1.8%)**,
