...
**779 test methods, 863 known invocations, 121 classes.** This source-exact forecast supports planning only;
...
**749 methods / 819 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 477 | 529 | 100 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 819 cases (2.0%)**,
