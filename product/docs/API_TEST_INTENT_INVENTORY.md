...
**665 test methods, 731 known invocations, 110 classes.** This source-exact forecast supports planning only;
...
**639 methods / 696 cases have direct host evidence**,
...
| EF translation / relational constraints | 143 | 154 | 53 | Infrastructure (needs a database, not a host) |
...
The known hosted candidate share is **16 of 696 cases (2.3%)**,
