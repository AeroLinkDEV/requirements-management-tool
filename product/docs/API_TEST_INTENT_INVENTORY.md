...
**798 test methods, 886 known invocations, 122 classes.** This source-exact forecast supports planning only;
...
**768 methods / 842 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 495 | 551 | 101 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 842 cases (1.9%)**,
