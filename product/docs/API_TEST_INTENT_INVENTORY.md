...
**967 test methods, 1093 known invocations, 152 classes.** This source-exact forecast supports planning only;
...
**918 methods / 1022 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 595 | 672 | 119 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 1022 cases (1.8%)**,
