...
**1001 test methods, 1146 known invocations, 158 classes.** This source-exact forecast supports planning only;
...
**946 methods / 1069 cases have direct host evidence**,
...
| Authentication / authorization wiring | 116 | 134 | 67 | API (must stay hosted) |
...
The known hosted candidate share is **19 of 1069 cases (1.8%)**,
