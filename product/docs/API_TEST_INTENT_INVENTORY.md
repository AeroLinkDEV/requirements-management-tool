...
**744 test methods, 828 known invocations, 119 classes.** This source-exact forecast supports planning only;
...
**714 methods / 784 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 445 | 497 | 98 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 784 cases (2.0%)**,
