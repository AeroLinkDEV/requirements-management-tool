...
**899 test methods, 1007 known invocations, 141 classes.** This source-exact forecast supports planning only;
...
**852 methods / 938 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 561 | 629 | 110 | API (must stay hosted) |
...
| In-process logic with no HTTP and no client | 41 | 41 | 17 | Domain or Infrastructure (migration candidate) |
...
The machine-readable artifact records **18 explicitly hosted candidate methods / 18 cases** and **7 unknown candidate methods / 15 cases**.
The known hosted candidate share is **18 of 938 cases (1.9%)**,
