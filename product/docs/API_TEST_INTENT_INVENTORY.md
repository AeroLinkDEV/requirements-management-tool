...
**851 methods / 937 cases have direct host evidence**,
...
The machine-readable artifact records **17 explicitly hosted candidate methods / 17 cases** and **8 unknown candidate methods / 16 cases**.
The known hosted candidate share is **17 of 937 cases (1.8%)**,
