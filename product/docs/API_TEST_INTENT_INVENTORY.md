...
**672 test methods, 738 known invocations, 110 classes.** This source-exact forecast supports planning only;
...
**645 methods / 702 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 407 | 449 | 91 | API (must stay hosted) |
| EF translation / relational constraints | 145 | 156 | 53 | Infrastructure (needs a database, not a host) |
...
The known hosted candidate share is **16 of 702 cases (2.3%)**,
