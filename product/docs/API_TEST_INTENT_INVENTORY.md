...
**929 test methods, 1045 known invocations, 147 classes.** This source-exact forecast supports planning only;
...
**881 methods / 975 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 575 | 649 | 113 | API (must stay hosted) |
| EF translation / relational constraints | 176 | 190 | 62 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 102 | 108 | 61 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 975 cases (1.8%)**,
