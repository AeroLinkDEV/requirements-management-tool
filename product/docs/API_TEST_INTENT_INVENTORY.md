...
**721 test methods, 804 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**692 methods / 761 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 429 | 483 | 95 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 761 cases (2.1%)**,
