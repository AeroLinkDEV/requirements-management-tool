...
**965 test methods, 1091 known invocations, 152 classes.** This source-exact forecast supports planning only;
...
**916 methods / 1020 cases have direct host evidence**,
...
The known hosted candidate share is **18 of 1020 cases (1.8%)**,
