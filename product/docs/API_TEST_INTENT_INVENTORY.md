...
**914 test methods, 1025 known invocations, 146 classes.** This source-exact forecast supports planning only;
...
**866 methods / 955 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 569 | 638 | 113 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 955 cases (1.9%)**,
