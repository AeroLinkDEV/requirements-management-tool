...
**743 test methods, 827 known invocations, 119 classes.** This source-exact forecast supports planning only;
...
**713 methods / 783 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 444 | 496 | 98 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 783 cases (2.0%)**,
