...
**912 test methods, 1023 known invocations, 146 classes.** This source-exact forecast supports planning only;
...
**864 methods / 953 cases have direct host evidence**,
...
The known hosted candidate share is **18 of 953 cases (1.9%)**,
