...
**997 test methods, 1142 known invocations, 156 classes.** This source-exact forecast supports planning only;
...
**942 methods / 1065 cases have direct host evidence**,
...
The known hosted candidate share is **18 of 1065 cases (1.7%)**,
