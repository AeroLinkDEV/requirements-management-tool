...
**723 test methods, 807 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**694 methods / 764 cases have direct host evidence**,
...
| EF translation / relational constraints | 155 | 169 | 56 | Infrastructure (needs a database, not a host) |
...
The known hosted candidate share is **16 of 764 cases (2.1%)**,
