...
**903 test methods, 1013 known invocations, 142 classes.** This source-exact forecast supports planning only;
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 565 | 635 | 111 | API (must stay hosted) |
