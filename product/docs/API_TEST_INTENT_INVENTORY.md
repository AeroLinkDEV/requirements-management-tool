...
**934 test methods, 1050 known invocations, 148 classes.** This source-exact forecast supports planning only;
...
**886 methods / 980 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 577 | 651 | 115 | API (must stay hosted) |
| EF translation / relational constraints | 178 | 192 | 63 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 103 | 109 | 62 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 980 cases (1.8%)**,
