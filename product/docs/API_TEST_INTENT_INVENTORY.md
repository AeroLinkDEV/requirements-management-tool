...
**896 test methods, 1004 known invocations, 138 classes.** This source-exact forecast supports planning only;
...
**849 methods / 935 cases have direct host evidence**,
...
The known hosted candidate share is **16 of 935 cases (1.7%)**,
