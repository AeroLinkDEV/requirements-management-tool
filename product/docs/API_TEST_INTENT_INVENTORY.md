...
**708 test methods, 789 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**679 methods / 746 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 421 | 473 | 95 | API (must stay hosted) |
| EF translation / relational constraints | 153 | 164 | 55 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 82 | 86 | 47 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 746 cases (2.1%)**,
