...
**647 test methods, 705 known invocations, 109 classes.** This source-exact forecast supports planning only;
...
| In-process logic with no HTTP and no client | 24 | 24 | 10 | Domain or Infrastructure (migration candidate) |
