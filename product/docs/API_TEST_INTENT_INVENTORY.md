...
**859 test methods, 956 known invocations, 128 classes.** This source-exact forecast supports planning only;
...
**821 methods / 904 cases have direct host evidence**,
...
The known hosted candidate share is **16 of 904 cases (1.8%)**,
