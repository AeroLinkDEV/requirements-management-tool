...
**719 test methods, 802 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**690 methods / 759 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 427 | 481 | 95 | API (must stay hosted) |
| EF translation / relational constraints | 153 | 164 | 55 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 84 | 88 | 48 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 759 cases (2.1%)**,
