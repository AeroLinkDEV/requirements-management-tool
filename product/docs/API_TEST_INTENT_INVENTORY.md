...
**994 test methods, 1134 known invocations, 157 classes.** This source-exact forecast supports planning only;
...
**937 methods / 1055 cases have direct host evidence**,
...
The known hosted candidate share is **18 of 1055 cases (1.7%)**,
