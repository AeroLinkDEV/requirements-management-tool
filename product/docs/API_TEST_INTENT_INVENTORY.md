...
**650 test methods, 708 known invocations, 110 classes.** This source-exact forecast supports planning only;
...
**630 methods / 679 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 400 | 434 | 92 | API (must stay hosted) |
| EF translation / relational constraints | 139 | 150 | 53 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 65 | 69 | 42 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 679 cases (2.4%)**,
