...
**876 test methods, 973 known invocations, 131 classes.** This source-exact forecast supports planning only;
...
**835 methods / 918 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 550 | 615 | 105 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 918 cases (1.7%)**,
