...
**820 test methods, 909 known invocations, 122 classes.** This source-exact forecast supports planning only;
...
**790 methods / 865 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 517 | 574 | 101 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 865 cases (1.8%)**,
