...
**753 test methods, 837 known invocations, 120 classes.** This source-exact forecast supports planning only;
...
**723 methods / 793 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 453 | 505 | 99 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 793 cases (2.0%)**,
