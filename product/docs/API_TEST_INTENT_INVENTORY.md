...
**871 test methods, 968 known invocations, 130 classes.** This source-exact forecast supports planning only;
...
**831 methods / 914 cases have direct host evidence**,
...
The known hosted candidate share is **16 of 914 cases (1.8%)**,
