...
**986 test methods, 1126 known invocations, 155 classes.** This source-exact forecast supports planning only;
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 611 | 697 | 122 | API (must stay hosted) |
