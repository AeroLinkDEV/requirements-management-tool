...
**722 test methods, 806 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**693 methods / 763 cases have direct host evidence**,
...
| EF translation / relational constraints | 154 | 168 | 56 | Infrastructure (needs a database, not a host) |
...
The known hosted candidate share is **16 of 763 cases (2.1%)**,
