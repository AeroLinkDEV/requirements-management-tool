...
**870 test methods, 967 known invocations, 130 classes.** This source-exact forecast supports planning only;
...
**830 methods / 913 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 546 | 611 | 105 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 913 cases (1.8%)**,
