...
**661 test methods, 727 known invocations, 110 classes.** This source-exact forecast supports planning only;
...
**635 methods / 692 cases have direct host evidence**,
...
| Authentication / authorization wiring | 67 | 71 | 42 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 692 cases (2.3%)**,
