...
**946 test methods, 1069 known invocations, 150 classes.** This source-exact forecast supports planning only;
...
**898 methods / 999 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 581 | 655 | 117 | API (must stay hosted) |
| EF translation / relational constraints | 181 | 195 | 64 | Infrastructure (needs a database, not a host) |
...
The known hosted candidate share is **18 of 999 cases (1.8%)**,
