...
**956 test methods, 1079 known invocations, 151 classes.** This source-exact forecast supports planning only;
...
**908 methods / 1009 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 589 | 663 | 118 | API (must stay hosted) |
| EF translation / relational constraints | 180 | 194 | 64 | Infrastructure (needs a database, not a host) |
...
| Startup, hosting and configuration | 12 | 12 | 8 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 1009 cases (1.8%)**,
