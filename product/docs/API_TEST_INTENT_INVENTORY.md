...
**860 test methods, 957 known invocations, 128 classes.** This source-exact forecast supports planning only;
...
**822 methods / 905 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 539 | 604 | 104 | API (must stay hosted) |
| EF translation / relational constraints | 166 | 180 | 59 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 92 | 96 | 54 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 905 cases (1.8%)**,
