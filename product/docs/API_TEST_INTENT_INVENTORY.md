...
**742 test methods, 826 known invocations, 119 classes.** This source-exact forecast supports planning only;
...
**712 methods / 782 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 443 | 495 | 98 | API (must stay hosted) |
| EF translation / relational constraints | 158 | 172 | 56 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 86 | 90 | 49 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 782 cases (2.0%)**,
