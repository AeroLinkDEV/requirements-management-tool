...
**968 test methods, 1094 known invocations, 152 classes.** This source-exact forecast supports planning only;
...
**919 methods / 1023 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 596 | 673 | 119 | API (must stay hosted) |
| EF translation / relational constraints | 183 | 197 | 66 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 109 | 122 | 64 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 1023 cases (1.8%)**,
