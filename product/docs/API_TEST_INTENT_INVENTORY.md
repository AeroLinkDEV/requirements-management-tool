...
**772 test methods, 856 known invocations, 121 classes.** This source-exact forecast supports planning only;
...
**742 methods / 812 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 471 | 523 | 100 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 812 cases (2.0%)**,
