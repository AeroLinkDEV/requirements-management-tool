...
**725 test methods, 809 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**696 methods / 766 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 429 | 481 | 95 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 766 cases (2.1%)**,
