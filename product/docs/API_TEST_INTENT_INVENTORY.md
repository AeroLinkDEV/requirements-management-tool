...
**769 test methods, 853 known invocations, 121 classes.** This source-exact forecast supports planning only;
...
**739 methods / 809 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 468 | 520 | 100 | API (must stay hosted) |
| EF translation / relational constraints | 158 | 172 | 56 | Infrastructure (needs a database, not a host) |
| Authentication / authorization wiring | 88 | 92 | 51 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 809 cases (2.0%)**,
