...
**952 test methods, 1075 known invocations, 151 classes.** This source-exact forecast supports planning only;
...
**904 methods / 1005 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 585 | 659 | 118 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 1005 cases (1.8%)**,
