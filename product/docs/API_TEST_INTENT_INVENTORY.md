...
**707 test methods, 788 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**678 methods / 745 cases have direct host evidence**,
...
| EF translation / relational constraints | 152 | 163 | 55 | Infrastructure (needs a database, not a host) |
...
The known hosted candidate share is **16 of 745 cases (2.1%)**,
