...
**695 test methods, 771 known invocations, 113 classes.** This source-exact forecast supports planning only;
...
**668 methods / 735 cases have direct host evidence**,
...
| EF translation / relational constraints | 148 | 159 | 55 | Infrastructure (needs a database, not a host) |
...
The known hosted candidate share is **16 of 735 cases (2.2%)**,
