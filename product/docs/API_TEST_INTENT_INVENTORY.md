...
**728 test methods, 812 known invocations, 116 classes.** This source-exact forecast supports planning only;
...
**699 methods / 769 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 432 | 484 | 95 | API (must stay hosted) |
...
The known hosted candidate share is **16 of 769 cases (2.1%)**,
