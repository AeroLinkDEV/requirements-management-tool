...
**995 test methods, 1135 known invocations, 157 classes.** This source-exact forecast supports planning only;
...
**938 methods / 1056 cases have direct host evidence**,
...
|---|---:|---:|---:|---|
| HTTP boundary: route, status, JSON shape | 612 | 698 | 123 | API (must stay hosted) |
...
The known hosted candidate share is **18 of 1056 cases (1.7%)**,
