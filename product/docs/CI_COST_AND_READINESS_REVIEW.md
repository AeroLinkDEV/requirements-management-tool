...
> qualification/feedback-time guidance is in [BROWSER_AND_BACKEND_FEEDBACK_TIME.md](BROWSER_AND_BACKEND_FEEDBACK_TIME.md).
> The former 2026-08-10 restart handoff is retained only in the
> [historical archive](../../docs/archive/CURRENT_PRODUCT_HANDOFF_2026-08-10.md).
>
