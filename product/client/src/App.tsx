    ...
    return inShell(
      <TestChangeRequestRegisterPage
        ...
        discipline={discipline === "softwareTest"
          ...
          : "System"}
        onBack={() => navigate("dashboard")}
        onOpen={id => navigate("testingCoverage", discipline, id, selectedArtifactKind)}
