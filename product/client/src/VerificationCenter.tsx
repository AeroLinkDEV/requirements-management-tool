...
type Props={api:string;programId:string;projectId:string;releaseId:string;readOnly:boolean;scope:'System'|'Software';user:AuthUser;correctiveProblemReportId?:string;onBack:()=>void}
...
export default function VerificationCenter({api,programId,projectId,releaseId,readOnly,scope,user,correctiveProblemReportId,onBack}:Props){
