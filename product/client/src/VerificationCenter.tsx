...
export default function VerificationCenter({api,programId,projectId,releaseId,buildName,readOnly,scope,user,correctiveProblemReportId,onBack}:Props){
 ...
 <section className="verificationContext" aria-label="Active software build"><div><small>ACTIVE SOFTWARE BUILD</small><b>{buildName}</b><span>Baseline and software build are one controlled configuration. Exit the workspace to select another build.</span></div></section>
