...
test('predecessor and successor keep exact titles and folded provenance through deep links', async ({ page }) => {
  ...
  await predecessorInspector.getByRole('tab', { name: 'Trace & impact' }).click()
  ...
  await predecessorInspector.getByRole('tab', { name: 'History' }).click()
  ...
  await successorInspector.getByRole('tab', { name: 'Trace & impact' }).click()
  ...
  await successorInspector.getByRole('tab', { name: 'History' }).click()
