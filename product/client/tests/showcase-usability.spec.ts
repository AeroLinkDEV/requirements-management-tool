...
test('showcase-critical surfaces are readable, focused, and progressively disclosed',async({page,request})=>{
  ...
  await expect(page.getByRole('button',{name:/Remove Search: SYSR-00000150 filter/})).toBeVisible()
  await page.getByRole('button',{name:/Remove Search: SYSR-00000150 filter/}).click()
