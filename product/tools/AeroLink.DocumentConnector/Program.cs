...
internal sealed class ConnectorForm : Form
{
    ...
    {
        foreach (var incomplete in Directory.EnumerateFiles(Path.GetDirectoryName(path)!, "download-*.tmp", SearchOption.TopDirectoryOnly))
