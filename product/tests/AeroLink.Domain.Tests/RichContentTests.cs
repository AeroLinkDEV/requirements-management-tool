...
public sealed class RichContentTests
{
    ...
    {
        var scr = new SystemChangeRequest("SRCR-00002", 0, Guid.NewGuid(), Guid.NewGuid(), "Routing",
    ...
    public void Restructuring_a_change_case_changes_its_review_snapshot()
    {
        ...
        {
            var scr = new SystemChangeRequest("SRCR-00003", 0, projectId, releaseId, "Routing",
