...
public sealed class FmsShowcaseSeederTests
{
    ...
    public async Task Fresh_identity_ordering_freezes_real_sqa_identity_and_covers_scenario_lifecycles()
    {
        ...
        try
        {
            ...
            Assert.Equal(10 + FmsShowcaseSeeder.ActiveTraceRequestCount, await db.SystemChangeRequests.CountAsync(x => x.ProjectId == summary.ProjectId && x.TargetReleaseId == summary.ActiveReleaseId));
