...
public sealed class JiraConnectorTests
{
    ...
    private static SystemChangeRequest Scr(Guid projectId) =>
        new("SCR-00000031", 0, projectId, Guid.NewGuid(), "Oceanic routing",
    ...
    {
        var link = new JiraIssueLink(Guid.NewGuid(), Guid.NewGuid(), "ChangeRequest", Guid.NewGuid(), "SCR-00000001.00", "engineer", Now);
