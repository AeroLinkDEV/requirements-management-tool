...
public sealed class ReqIfExchangeTests
{
    ...
    public void Parser_maps_explicit_levels_and_uses_the_legacy_system_fallback_for_unknown_or_missing_levels()
    {
        const string xml = """
            <REQ-IF xmlns="http://www.omg.org/spec/ReqIF/20110401/reqif.xsd">
              <REQ-IF-CONTENT>
                ...
                <SPEC-OBJECTS>
                  <SPEC-OBJECT IDENTIFIER="OBJ-SYSTEM"><VALUES>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="SYSR-000001"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-IDENTIFIER</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="System"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-LEVEL</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="System statement"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-STATEMENT</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                  </VALUES></SPEC-OBJECT>
                  <SPEC-OBJECT IDENTIFIER="OBJ-HLR"><VALUES>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="HLR-000002"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-IDENTIFIER</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="HighLevel"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-LEVEL</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="High-level statement"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-STATEMENT</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                  </VALUES></SPEC-OBJECT>
                  <SPEC-OBJECT IDENTIFIER="OBJ-LLR"><VALUES>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="LLR-000003"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-IDENTIFIER</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="LowLevel"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-LEVEL</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="Low-level statement"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-STATEMENT</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                  </VALUES></SPEC-OBJECT>
                  <SPEC-OBJECT IDENTIFIER="OBJ-UNKNOWN"><VALUES>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="EXT-UNKNOWN"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-IDENTIFIER</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="SubSystem"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-LEVEL</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="Unknown-level statement"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-STATEMENT</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                  </VALUES></SPEC-OBJECT>
                  <SPEC-OBJECT IDENTIFIER="OBJ-MISSING"><VALUES>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="EXT-MISSING"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-IDENTIFIER</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                    <ATTRIBUTE-VALUE-STRING THE-VALUE="Missing-level statement"><DEFINITION><ATTRIBUTE-DEFINITION-STRING-REF>AD-STATEMENT</ATTRIBUTE-DEFINITION-STRING-REF></DEFINITION></ATTRIBUTE-VALUE-STRING>
                  </VALUES></SPEC-OBJECT>
                </SPEC-OBJECTS>
              </REQ-IF-CONTENT>
            </REQ-IF>
        ...
        var manifest = ReqIfExchangeService.ParsePackage(stream, "levels.reqif");

        Assert.Equal(["System", "HighLevel", "LowLevel", "System", "System"], manifest.Items.Select(x => x.Level).ToArray());
        Assert.Equal(["SYSR-000001", "HLR-000002", "LLR-000003", "EXT-UNKNOWN", "EXT-MISSING"], manifest.Items.Select(x => x.Identifier).ToArray());
        Assert.Contains(manifest.Warnings, x => x.Contains("SubSystem", StringComparison.Ordinal));
        Assert.DoesNotContain(manifest.Warnings, x => x.Contains("EXT-MISSING", StringComparison.Ordinal));
        Assert.All(manifest.Items, item => Assert.True(item.Valid));
    }
