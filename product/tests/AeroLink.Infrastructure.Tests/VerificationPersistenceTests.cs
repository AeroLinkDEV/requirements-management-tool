...
public sealed class VerificationPersistenceTests
{
    ...
    public async Task One_procedure_covers_multiple_exact_requirements_and_retest_preserves_failed_run()
    {
        ...
        try
        {
            ...
            scr.AddRequirementChange("author", "SWR-00000001", 0, RequirementLevel.HighLevel, RequirementChangeKind.Introduce, "First behavior", "R", "Test", now, attributesJson: "{\"derived\":true}");
            scr.AddRequirementChange("author", "SWR-00000002", 0, RequirementLevel.HighLevel, RequirementChangeKind.Introduce, "Second behavior", "R", "Test", now, attributesJson: "{\"derived\":true}");
