...
public sealed class ManagedDocumentShowcaseSeeder(AeroLinkDbContext db, ManagedDocumentFileService files)
{
    ...
    [
        ...
        [new("2.1", "References", "Governing lifecycle data", "DO-178C objectives, approved project plans, controlled requirements, verification artifacts, problem reports and change requests apply as identified by the project configuration.", [("Precedence", "Approved project and certification data")]),
    ...
    private static string Process(string acronym) => acronym switch
    {
        ...
        "SVP" => "Verification combines reviews, analyses and tests. Changed requirements automatically identify impacted verification artifacts that remain mandatory until satisfactory execution evidence is recorded.",
