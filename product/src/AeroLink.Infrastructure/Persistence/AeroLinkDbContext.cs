...
public sealed class AeroLinkDbContext(DbContextOptions<AeroLinkDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            b.ToTable("problem_report_revisions"); b.HasKey(x => x.Id); b.Property(x => x.EventType).HasMaxLength(80).IsRequired(); b.Property(x => x.Actor).HasMaxLength(100).IsRequired(); b.Property(x => x.SnapshotHash).HasMaxLength(64).IsRequired(); b.Property(x => x.SnapshotJson).IsRequired(); b.Property(x => x.SnapshotSchemaVersion).IsRequired(); b.Property(x => x.Detail).HasMaxLength(2000).IsRequired(); b.Property(x => x.FromState).HasMaxLength(40).IsRequired(); b.Property(x => x.ToState).HasMaxLength(40).IsRequired(); b.Property(x => x.Rationale).HasMaxLength(4000).IsRequired(); b.Property(x => x.EvidenceJson); b.Property(x => x.EventSchemaVersion).IsRequired();
