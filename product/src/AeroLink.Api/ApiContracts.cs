...
record CreateScrRequest(string BaseNumber, Guid ProjectId, Guid TargetReleaseId, string Title, string Problem, string Analysis, string Solution, ChangeRequestType Type = ChangeRequestType.System, string? ProblemRich = null, string? AnalysisRich = null, string? SolutionRich = null, List<Guid>? ProblemReportIds = null);
